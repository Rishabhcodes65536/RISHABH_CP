...
// while (h-l>1e-6) {
//     double mid = l + (h - l) / 2;
//     double max_reach = vep[0].first + (mid - vep[0].second);
//     double min_reach = vep[0].first - (mid - vep[0].second);
//     for (int i = 1; i < vep.size();i++){
//         min_reach = max(min_reach, vep[i].first - (mid - vep[i].second));
//         max_reach = min(max_reach, vep[i].first + (mid - vep[i].second));
//     }
...
while (l <= h) {
    int mid = l + (h - l) / 2;
    int max_reach = vep[0].first + (mid - vep[0].second);
    int min_reach = vep[0].first - (mid - vep[0].second);
    for (int i = 1; i < vep.size();i++){
        min_reach = max(min_reach, vep[i].first - (mid - vep[i].second));
        max_reach = min(max_reach, vep[i].first + (mid - vep[i].second));
    }
...
//0 0 0 0 0 1 2 2 2 2 2 3 3 3 3 3 4 4 4 4 4


// 0 0 0  1 1 1 1 1 2 2 2 3 4 4 4 5 5 5 6 7 7 7 7 7 7 