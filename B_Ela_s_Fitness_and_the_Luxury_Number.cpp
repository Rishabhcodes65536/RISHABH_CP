...
int a=sqrtl(l);
int b=sqrtl(r);
int initialcount=3LL;
int u=3LL*(b-a+1LL);
//cout<<u<<endl;
if(l>pow(a,2LL) && l<=power(a,2LL)+a){
    u--;//110
}
else if(l>power(a,2LL)+a && l<=power(a,2LL) + 2LL*a){
    u-=2LL;
}
//cout<<u<<endl;
if(r>=power(b,2LL) + b && r<power(b,2LL) + 2LL*b){
    u--; //
}
else if(r<power(b,2LL)+b){
    u-=2LL;
}
cout<<u<<endl;
}
