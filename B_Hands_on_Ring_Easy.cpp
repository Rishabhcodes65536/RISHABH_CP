...
void winterIsComing(){
    ...
    rep(i,0,k){
        ...
        w--;
        if(c=='L'){
            int op1 = 0, op2 = 0,c1=0,c2=0;
            int tpr = posl, tpr2 = posl;
            while(tpr!=w && tpr!=posr){
                tpr++;
                tpr %= n;
                c1++;
            }
            while (tpr2 != w && tpr2 != posr)
            {
                tpr2--;
                tpr2 += n;
                tpr2 %= n;
            ...
            int op1 = 0, op2 = 0, c1 = 0, c2 = 0;
            int tpr = posr, tpr2 = posr;
            while (tpr != w && tpr != posl)
            {
                tpr++;
                tpr %= n;
                c1++;
            }
            while (tpr2 != w && tpr2 != posl)
            {
                tpr2--;
                tpr2 += n;
                tpr2 %= n;
