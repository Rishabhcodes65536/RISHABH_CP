...
static bool cond(const vector<int> &a, const vector<int> &b)
{
...
void dosomething()
{
    ...
    auto calc = [&](int u, int v)
    {
        ...
        if (u != 0)
        {
            if (u > 0)
            {
                p = "1 " + to_string(abs(u)) + " R";
                p_ = "1 " + to_string(abs(u)) + " L";
            }
            else
            {
                p = "1 " + to_string(abs(u)) + " L";
                p_ = "1 " + to_string(abs(u)) + " R";
            }
        }
        ...
        if (v != 0)
        {
            if (v > 0)
            {
                q = "1 " + to_string(abs(v)) + " U";
                q_ = "1 " + to_string(abs(v)) + " D";
            }
            else
            {
                q = "1 " + to_string(abs(v)) + " D";
                q_ = "1 " + to_string(abs(v)) + " U";
            }
        }
        if (u != 0)
        {
