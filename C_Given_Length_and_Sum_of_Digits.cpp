...
// if (n < r) return 0;
// if (r == 0) return 1;
// int a = mod_mul(FAC[n], INV[r], M);
// a = mod_mul(a, INV[n - r], M);
// return a;
// }
string createbase(int n){
    string tmp="";
    rep(i,0,n){
        tmp+='0';
    }
