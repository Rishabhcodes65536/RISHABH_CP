...
rep(i,0,q){
    ...
    if(choice==1){
        ...
        int a,b,p,q;
        cin>>a>>b>>p>>q;
        auto roit1=ro.find(a);
        auto roit2=ro.find(p);
        auto coit1=co.find(b);
        auto coit2=co.find(q);
        // if(roit1==ro.end() || roit2==ro.end() ||  coit1==co.end() || coit2==co.end()){
            // cout<<"No"<<endl;
        
        int dist1=distance(roit1,roit2);
        int dist2=distance(coit1,coit2);
        cout<<dist1<<" "<<dist2<<endl;
        if(dist1!=p-a || dist2!=q-b){
            cout<<"No"<<endl;
        }
        else{
            cout<<"Yes"<<endl;
