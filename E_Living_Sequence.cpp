...
int countDigitK(int n, int k) {
    ...
    for (long long power = 1; power <= n; power *= 10) {
        ...
        if (digit < k) {
            count_k += quotient / 10 * power;
        } else if (digit == k) {
            count_k += quotient / 10 * power + remainder + 1 - power;
        } else if (k == 0 && quotient == 0) {
            count_k -= power;
        } else {
            count_k += (quotient / 10 + 1) * power;
        }
    }
    return count_k;
}
...
//     int n = 121;
//     int k = 4;
//     int count_k = countDigitK(n, k);
//     cout << "The frequency of digit " << k << " in the range [0, " << n << "] is " << count_k << endl;
//     return 0;
// }
...
int n;
cin>>n;
cout<<countDigitFour(121)<<endl;
cout<<countDigitFour(18937)<<endl;
// cout<<n+countDigitK(22,4)<<endl;
// cout<<n+countDigitK(10,4)<<endl;
// cout<<n+countDigitK(100,4)<<endl;
// cout<<n+countDigitK(12345,4)<<endl;
// cout<<n+countDigitK(3,4)<<endl;
}
signed main(){
