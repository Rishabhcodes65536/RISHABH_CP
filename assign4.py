...
term_userdef=['d','a','g','b']
sample_input_string="a b"
diction = {}
firsts = {}
follows = {}
...
if sample_input_string != None:
	validity = validateStringUsingStackBuffer(parsing_table, result,tabTerm, sample_input_string,term_userdef,start_symbol)
	print(validity)
else:
