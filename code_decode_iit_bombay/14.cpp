...
bool countDivisors2(int n,set <int>& st){int cnt = 0;for (int i = 1; i <= sqrt(n); i++) { if (n % i == 0 && st.find(i)!=st.end() && st.find(n/i)!=st.end() && i!=n/i){return true;}}return false;}
