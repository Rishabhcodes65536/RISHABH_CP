...
//B-Tech 
vector <string> finder(string root,string& file,vector <string>& ans,map <string,vector <string>>& mp,map <string,int>& visited){
...
// cout<<"Enter the root directory"<<endl;
string root;
cin>>root;
...
cin>>n;
rep(i,0,n){
    // cout<<"Please Enter the links for path"<<endl;
    string p,q;
    cin>>p>>q;
    mp[p].pb(q);
    mp[q].pb(p);
    ...
    // cout<<"Press 1 to search any key to exit"<<endl;
    // int cases;
    // cin>>cases;
    //switch (cases)
        //case 1:
        //cout<<"Please enter file to to search"<<endl;
         string file;
         cin>>file;
         vector <string> ans;
         map <string,int> visited;
         vector <string> path=finder(root,file,ans,mp,visited);
         if(path.empty()){
            cout<<"Not Found"<<endl;
         }
         //break;
